...
constant_widgets = {}
variables = {}
DEFAULT_SKIN = "DarknessHD/skin.xml"
...
except (SkinError, IOError as AssertionError) as err:
...
try:
    if config.skin.primary_skin.value == "DarknessHD/skin.xml" or config.skin.primary_skin.value == DEFAULT_SKIN:
        cachemenu()
except:
...
class AttributeParser:
    ...
    def applyOne(self, attrib, value):
        try:
            ...
            print("\0o33[91m[SKIN] Error:", ex, end=' ')
            print("\0o33[0m")
        except:
        ...
        if wname:
            try:
                ...
                if config.crash.skin_error_crash.value:
                    ...
                    print("\0o33[91m[SKIN] ERROR - given constant-widget: '%s' not found in skin\0o33[0m" % wname)
                    return
        if cwvalue:
            for x in cwvalue:
                myscreen.append((x))
...
#			print("Widget source=", wsource)
            ...
            if source is None:
                if config.crash.skin_error_crash.value:
                    ...
                    print("\0o33[91m[Skin] Error: Source '" + wsource + "' was not found in screen '" + name + "'!")
            ...
            for converter in widget.findall("convert"):
                ...
                try:
                    ...
                    if config.crash.skin_error_crash.value:
                        ...
                        print("\0o33[91m[Skin] Error: Converter '%s' not found\0o33[0m" % ctype)
                c = None
            ...
            try:
                ...
                if config.crash.skin_error_crash.value:
                    ...
                    print("\0o33[91m[Skin] Error: Renderer '%s' not found\0o33[0m" % wrender)
                    return
