...
try:
	if config.skin.primary_skin.value == "Elgato-HD-CN/skin.xml" or config.skin.primary_skin.value == "Elgato-HD-CN/skin.xml" or config.skin.primary_skin.value == DEFAULT_SKIN:
		cachemenu()
except:
