...
<screen name="HardwareInfobis" position="center,center" size="640,480">
	<ePixmap position="20,30" zPosition="5" size="50,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/icons/ram.png" alphatest="blend" />
	<widget source="session.Event_Now" render="Progress" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/icons/bar.png" position="90,30" size="515,20" transparent="1" zPosition="6">
	...
	<ePixmap position="20,110" zPosition="1" size="50,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/icons/swap.png" alphatest="blend" />
	<widget source="session.Event_Now" render="Progress" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/icons/bar.png" position="90,110" size="515,20" transparent="1" zPosition="6">
	...
	<ePixmap position="20,190" zPosition="1" size="50,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/icons/flash.png" alphatest="blend" />
	<widget source="session.Event_Now" render="Progress" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/icons/bar.png" position="90,190" size="515,20" transparent="1" zPosition="6">
	...
	<ePixmap position="20,270" zPosition="1" size="50,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/icons/hdd.png" alphatest="blend" />
	<widget source="session.Event_Now" render="Progress" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/icons/bar.png" position="90,270" size="515,20" transparent="1" zPosition="6">
	...
	<ePixmap position="20,350" zPosition="1" size="50,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/icons/pen.png" alphatest="blend" />
	<widget source="session.Event_Now" render="Progress" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/icons/bar.png" position="90,350" size="515,20" transparent="1" zPosition="6">
