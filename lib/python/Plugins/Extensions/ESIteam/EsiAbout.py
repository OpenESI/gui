...
class EsisysInfo(Screen):
	skin = """
<screen name="EsisysInfo" position="70,35" size="1150,650">
	...
	def infohard(self):
		from Plugins.Extensions.ESIteam.EsiHardware import HardwareInfo
		self.session.open(HardwareInfo)

	def infoteam(self):
		from Plugins.Extensions.ESIteam.EsiTeam import EsiAboutTeam
		self.session.open(EsiAboutTeam)
