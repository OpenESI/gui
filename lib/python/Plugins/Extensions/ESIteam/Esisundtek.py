...
class SundtekControlCenter(Screen, ConfigListScreen):
	skin = """
		<screen title="SundtekControlCenter" position="center,center" size="570,400" name="SundtekControlCenter">
			<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/buttons/red.png" position="0,0" size="140,40" alphatest="on" />
			<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/buttons/green.png" position="140,0" size="140,40" alphatest="on" />
			<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/buttons/yellow.png" position="280,0" size="140,40" alphatest="on" />
			<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/buttons/blue.png" position="420,0" size="140,40" alphatest="on" />
			...
			<ePixmap position="460, 350" size="100,40" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/icons/sundtek.png" transparent="1" alphatest="on" />
		</screen>"""
	...
	def disclaimer(self, result):
		if result:
			self.prompt("/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/scripts/sundtekinstall.sh")
