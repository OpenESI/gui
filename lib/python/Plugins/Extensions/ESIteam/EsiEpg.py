...
config.plugins.esiteam.auto2 = ConfigSelection(default='no', choices=[('no', _('no')), ('yes', _('yes'))])
config.plugins.esiteam.dropmode = ConfigSelection(default = '1', choices = [
		('1', _("free pagecache")),
		('2', _("free dentries and inodes")),
		('3', _("free pagecache, dentries and inodes")),
		])
config.plugins.esiteam.epgtime2 = ConfigClock(default=58500)
config.plugins.esiteam.epgmhw2wait = ConfigNumber(default=350) # 350 seconds = 5,83 minutes
...
class Ttimer(Screen):
 ...
 <widget source="Title" transparent="1" render="Label" zPosition="2" valign="center" halign="left" position="100,70" size="800,50" font="Regular; 30" backgroundColor="black" foregroundColor="white" noWrap="1" />
	...
	def __init__(self, session):
		...
		self['progress'].setRange(int(config.plugins.esiteam.epgmhw2wait.value - 5))
	...
	def __run(self):
		...
		if count > config.plugins.esiteam.epgmhw2wait.value:
			self.ctimer.stop()
...
class ESIepgScreen(Screen, ConfigListScreen):
	skin = """
	<screen name="ESIepgScreen" position="center,center" size="1150,650">
...
<widget source="global.CurrentTime" render="Label" position="35,10" size="500,24" font="Regular;22" foregroundColor="#FFFFFF" halign="left" transparent="1" zPosition="5">
  ...
  <ePixmap position="30,590" zPosition="1" size="165,2" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/buttons/red150x30.png" alphatest="blend" />
  ...
  <ePixmap position="200,590" zPosition="1" size="165,2" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/buttons/green150x30.png" alphatest="blend" />
<ePixmap position="370,590" zPosition="1" size="165,2" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/buttons/yellow150x30.png" alphatest="blend" />
<ePixmap position="540,590" zPosition="1" size="165,2" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/buttons/blue150x30.png" alphatest="blend" />
...
<widget source="key_yellow" render="Label" position="370,590" zPosition="2" size="165,30" font="Regular;20" halign="center" valign="center" backgroundColor="background" foregroundColor="foreground" transparent="1" />
	...
	def __init__(self, session):
		...
		if config.plugins.esiteam.epgmhw2wait:
			try:
				self.list.append(getConfigListEntry(_('Time at title page'), config.plugins.esiteam.epgmhw2wait))
			except:
				pass
	...
	def save(self):
		...
		epgcache = eEPGCache.getInstance().save()
		config.plugins.esiteam.epgmhw2wait.save()
		config.epg.save()
...
<screen name="Viewmhw" position="center,80" size="1170,600" title="View mhw2equiv.conf (/etc/mhw2equiv.conf">
	<ePixmap position="20,590" zPosition="1" size="170,2" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/buttons/red150x30.png" alphatest="blend" />
