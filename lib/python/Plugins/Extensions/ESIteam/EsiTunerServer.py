...
class TunerServer(Screen):
	if config.osd.language.value == 'es_ES':
		...
		<screen position="center,center" size="905,610" >
			...
			<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/buttons/red150x30.png" position="125,550" size="150,40" alphatest="on"/>
			<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/buttons/green150x30.png" position="365,550" size="150,40" alphatest="on"/>
			<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/images/buttons/yellow150x30.png" position="600,550" size="150,40" alphatest="on" />
		...
		def __init__(self, session):
			...
			Screen.setTitle(self, _('Tuner Server OpenESI'))
			mytext = """
