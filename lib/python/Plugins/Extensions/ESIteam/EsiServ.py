...
class ESIServices(Screen):
	skin = """
<screen name="ESIServices" position="70,35" size="1150,650">
...
"itemHeight": 40
	...
	def KeyOk(self):
		...
		if self.sel == 0:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkSamba
			self.session.open(NetworkSamba)
		elif self.sel == 1:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkNfs
			self.session.open(NetworkNfs)
		elif self.sel == 2:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkOpenvpn
			self.session.open(NetworkOpenvpn)
		elif self.sel == 3:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkInadyn
			self.session.open(NetworkInadyn)
		elif self.sel == 4:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkMiniDLNA
			self.session.open(NetworkMiniDLNA)
		elif self.sel == 5:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkFtp
			self.session.open(NetworkFtp)
		elif self.sel == 6:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkAfp
			self.session.open(NetworkAfp)
		elif self.sel == 7:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkuShare
			self.session.open(NetworkuShare)
		elif self.sel == 8:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkTelnet
			self.session.open(NetworkTelnet)
		elif self.sel == 9:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkUdpxy
			self.session.open(NetworkUdpxy)
		elif self.sel == 10:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkXupnpd
			self.session.open(NetworkXupnpd)
		elif self.sel == 11:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkDjmount
			self.session.open(NetworkDjmount)
		elif self.sel == 12:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkMediatomb
			self.session.open(NetworkMediatomb)
		elif self.sel == 13:
			from Plugins.Extensions.ESIteam.EsiTunerServer import TunerServer
			self.session.open(TunerServer)
		elif self.sel == 14:
			from Plugins.Extensions.ESIteam.EsiNetworkSetup import NetworkTransmission
