...
class ESIScripts(Screen):
	skin = """
<screen name="ESIScripts" position="70,35" size="1150,650">
...
<widget name="statuslab" position="10,590" size="780,70" font="Regular;16" valign="center" noWrap="1" backgroundColor="#333f3f3f" foregroundColor="#FFC000" shadowOffset="-2,-2" shadowColor="black" />
	...
	def populateSL(self):
		myscripts = listdir("/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/scripts")
		for fil in myscripts:
			if fil.find('.sh') != -1:
				fil2 = fil[:-3]
				desc = "N/A"
				f = open("/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/scripts/" + fil,'r')
	...
	def myGo(self):
		...
		if mysel:
			mysel = mysel[0]
			mysel2 = "/usr/lib/enigma2/python/Plugins/Extensions/ESIteam/scripts/" + mysel + ".sh"
