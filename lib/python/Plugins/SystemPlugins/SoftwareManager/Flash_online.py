...
class doFlashImage(Screen):
	...
	def flashWithRestoreQuestion(self):
		try:
			if os.path.exists('/media/hdd/images/esirestore'):
				os.unlink('/media/hdd/images/esirestore')
				print "AfterFlashAction: delete /media/hdd/images/esirestore"
		except:
			print "AfterFlashAction: failed to delete /media/hdd/images/esirestore"
		...
		if answer is not None:
			...
			if answer[1] == "completerestore":
				try:
					...
					print "AfterFlashAction: create /media/hdd/images/esirestore"
					print "AfterFlashAction: filename:",self.fullbackupfilename
					backupsourcefile = self.fullbackupfilename
					backupdestfile = '/media/hdd/images/esirestore'
					...
					print "AfterFlashAction: failed to create /media/hdd/images/esirestore"
