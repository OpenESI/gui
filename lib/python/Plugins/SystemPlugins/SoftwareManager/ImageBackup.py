...
class ImageBackup(Screen):
	...
	def __init__(self, session, args = 0):
		...
		self["info-usb"] = Label(_("USB = Want to make an USB-backup image on HDD?\nThis will take between 7 and 15 minutes depending on the use file system and is fully automatic.\nMake sure you first insert an USB flash drive before you select USB."))
		self["info-hdd"] = Label(_("HDD = Want to make an USB-backup image on  HDD? \nThis only takes 4 or 10 minutes and is fully automatic."))
	...
	def imageInfo(self):
		AboutText = _("Full Backup ")
		AboutText += _("By Euro-Sat-Image") + "\n"
