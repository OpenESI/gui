...
class ISO639Language:
	...
	def __init__(self, depth=PRIMARY):
		...
		if depth == self.PRIMARY:
			wanted_languages = [ "Undetermined", "English", "Italian", "Arabic", "Catalan", "Croatian", "Czech", "Danish", "Dutch", "Estonian", "Finnish", "French", "German", "Greek", "Hungarian", "Lithuanian", "Latvian", "Icelandic", "Norwegian", "Polish", "Portuguese", "Russian", "Serbian", "Slovakian", "Slovenian", "Spanish", "Swedish", "Turkish", "Ukrainian" ]
