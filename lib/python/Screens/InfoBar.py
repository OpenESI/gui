...
class InfoBar(InfoBarBase, InfoBarShowHide,
	...
	def __init__(self, session):
		...
		if config.usage.show_infobar_lite.value and (config.skin.primary_skin.value == "DarknessHD/skin.xml" or config.skin.primary_skin.value.startswith('DarknessHD/')):
	...
	def showMediaCenter(self):
		try:
			from Plugins.Extensions.BMediaCenter.plugin import DarknessHD_MainMenu
			self.session.open(DarknessHD_MainMenu)
			no_plugin = False
		except Exception as e:
