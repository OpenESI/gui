...
# 	STATE_CHOISE_SOFTCAM = 2
	...
	def __init__(self, session, args = None):
		...
		if self.index == self.STATE_UPDATE:
			...
			modes = {"EuroSat": "EuroSat default(13e-19e)", "19e": "Astra 1", "23e": "Astra 3", "19e-23e": "Astra 1 Astra 3", "19e-23e-28e": "Astra 1 Astra 2 Astra 3", "13e-19e-23e-28e": "Astra 1 Astra 2 Astra 3 Hotbird"}
			self.channellist_type = ConfigSelection(choices = modes, default = "EuroSat")
			self.createMenu()
...
# 				self.list.append(getConfigListEntry(_("Softcam type"), self.softcam_type))
	...
	def run(self):
		...
		elif self.index == self.STATE_CHOISE_CHANNELLIST and self.enabled.value and self.channellist_type.value != "EuroSat":
