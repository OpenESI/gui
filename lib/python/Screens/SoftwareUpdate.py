...
class UpdatePlugin(Screen):
	...
	def checkNetworkStateFinished(self, result, retval,extra_args=None):
		if 'bad address' in result:
			...
			self.session.openWithCallback(self.close, MessageBox, _("Sorry feeds are down for maintenance, please try again later. If this issue persists please check www.openesi.eu"), type=MessageBox.TYPE_INFO, timeout=10, close_on_any_key=True)
