	...
	def setLang(self):
		if self.lang == 'de_DE':
			...
			self.keys_list = [
				...
				["<", "z", "x", "c", "v", "b", "n", "m", ",", ".", "-", "ALL"],
				["SHIFT", "SPACE", "@", "á", "é", "í", "ó", "ú", "ü", "º", "ª", "OK"]]
			self.shiftkeys_list = [
				["EXIT", "!", '"', "·", "$", "%", "&", "/", "(", ")", "=", "BACKSPACE"],
				["Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "¿", "?"],
				["A", "S", "D", "F", "G", "H", "J", "K", "L", "Ñ", "Ç", "*"],
				[">", "Z", "X", "C", "V", "B", "N", "M", ";", ":", "_", "CLEAR"],
				["SHIFT", "SPACE", "€", "Á", "É", "Í", "Ó", "Ú", "Ü", "[", "]", "OK"]]
			self.nextLang = 'fi_FI'
			...
			self.keys_list = [
				...
				["a", "s", "d", "f", "g", "h", "j", "k", "l", "ö", "ä", "#"],
				["<", "y", "x", "c", "v", "b", "n", "m", ",", ".", "-", "ALL"],
				["SHIFT", "SPACE", "@", "ß", "ĺ", "OK", "LEFT", "RIGHT"]]
			self.shiftkeys_list = [
				["EXIT", "!", '"', "§", "$", "%", "&", "/", "(", ")", "=", "BACKSPACE"],
				["Q", "W", "E", "R", "T", "Z", "U", "I", "O", "P", "É", "*"],
				["A", "S", "D", "F", "G", "H", "J", "K", "L", "Ö", "Ä", "'"],
				[">", "Y", "X", "C", "V", "B", "N", "M", ";", ":", "_", "CLEAR"],
				["SHIFT", "SPACE", "?", "\\", "Ĺ", "OK", "LEFT", "RIGHT"]]
			self.nextLang = 'lv_LV'
			...
			self.keys_list = [
				...
				["a", "s", "d", "f", "g", "h", "j", "k", "l", ";", "'", "ū"],
				["<", "z", "x", "c", "v", "b", "n", "m", ",", ".", "ž", "ALL"],
				["SHIFT", "SPACE", "ā", "č", "ē", "ģ", "ī", "ķ", "ļ", "ņ", "LEFT", "RIGHT"]]
			self.shiftkeys_list = [
				["EXIT", "!", "@", "$", "*", "(", ")", "_", "=", "/", "\\", "BACKSPACE"],
				["Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "+", "Š"],
				["A", "S", "D", "F", "G", "H", "J", "K", "L", ":", '"', "Ū"],
				[">", "Z", "X", "C", "V", "B", "N", "M", "#", "?", "Ž", "CLEAR"],
				["SHIFT", "SPACE", "Ā", "Č", "Ē", "Ģ", "Ī", "Ķ", "Ļ", "Ņ", "LEFT", "RIGHT"]]
			self.nextLang = 'ru_RU'
			...
			self.keys_list = [
				...
				["<", "х", "ц", "ч", "ш", "щ", "ъ", "ы", ",", ".", "-", "ALL"],
				["SHIFT", "SPACE", "@", "ь", "э", "ю", "я", "OK", "LEFT", "RIGHT"]]
			self.shiftkeys_list = [
				["EXIT", "!", '"', "§", "$", "%", "&", "/", "(", ")", "=", "BACKSPACE"],
				["А", "Б", "В", "Г", "Д", "Е", "Ё", "Ж", "З", "И", "Й", "*"],
				["К", "Л", "М", "Н", "О", "П", "Р", "С", "Т", "У", "Ф", "'"],
				[">", "Х", "Ц", "Ч", "Ш", "Щ", "Ъ", "Ы", ";", ":", "_", "CLEAR"],
				["SHIFT", "SPACE", "?", "\\", "Ь", "Э", "Ю", "Я", "OK", "LEFT", "RIGHT"]]
			self.nextLang = 'sv_SE'
			...
			self.keys_list = [
				...
				["a", "s", "d", "f", "g", "h", "j", "k", "l", "ľ", "@", "#"],
				["<", "y", "x", "c", "v", "b", "n", "m", ",", ".", "-", "ALL"],
				["SHIFT", "SPACE", "š", "č", "ž", "ý", "á", "í", "é", "OK", "LEFT", "RIGHT"]]
			self.shiftkeys_list = [
				["EXIT", "!", '"', "§", "$", "%", "&", "/", "(", ")", "=", "BACKSPACE"],
			...
			self.keys_list = [
				...
				["α", "σ", "δ", "φ", "γ", "η", "ξ", "κ", "λ", ";", "'", "-"],
				["\\", "ζ", "χ", "ψ", "ω", "β", "ν", "μ", ",", ".", "/", "ALL"],
				["SHIFT", "SPACE", "ά", "έ", "ή", "ί", "ό", "ύ", "ώ", "ϊ", "ϋ", "OK"]]
			self.shiftkeys_list = [
				["EXIT", "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "BACKSPACE"],
				["+", "€", "Ε", "Ρ", "Τ", "Υ", "Θ", "Ι", "Ο", "Π", "{", "}"],
				["Α", "Σ", "Δ", "Φ", "Γ", "Η", "Ξ", "Κ", "Λ", ":", '"', "_"],
			...
			self.keys_list = [
				...
				["a", "s", "d", "f", "g", "h", "j", "k", "l", ";", "'", "\\"],
				["<", "z", "x", "c", "v", "b", "n", "m", ",", ".", "/", "ALL"],
				["SHIFT", "SPACE", "ą", "ć", "ę", "ł", "ń", "ó", "ś", "ź", "ż", "OK"]]
			self.shiftkeys_list = [
				["EXIT", "!", "@", "#", "$", "%", "^", "&", "(", ")", "=", "BACKSPACE"],
				["Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "*", "]"],
				["A", "S", "D", "F", "G", "H", "J", "K", "L", "?", '"', "|"],
			...
			self.keys_list = [["EXIT", "\xe0\xb9\x85", "\xe0\xb8\xa0", "\xe0\xb8\x96", "\xe0\xb8\xb8", "\xe0\xb8\xb6", "\xe0\xb8\x84", "\xe0\xb8\x95", "\xe0\xb8\x88", "\xe0\xb8\x82", "\xe0\xb8\x8a", "BACKSPACE"],
				...
				["\xe0\xb8\x9c", "\xe0\xb8\x9b", "\xe0\xb9\x81", "\xe0\xb8\xad", "\xe0\xb8\xb4", "\xe0\xb8\xb7", "\xe0\xb8\x97", "\xe0\xb8\xa1", "\xe0\xb9\x83", "\xe0\xb8\x9d", "", "ALL"],
				["SHIFT", "SPACE", "OK", "LEFT", "RIGHT"]]
			self.shiftkeys_list = [["EXIT", "\xe0\xb9\x91", "\xe0\xb9\x92", "\xe0\xb9\x93", "\xe0\xb9\x94", "\xe0\xb8\xb9", "\xe0\xb9\x95", "\xe0\xb9\x96", "\xe0\xb9\x97", "\xe0\xb9\x98", "\xe0\xb9\x99", "BACKSPACE"],
				...
				["", "", "\xe0\xb8\x89", "\xe0\xb8\xae", "\xe0\xb8\xba", "\xe0\xb9\x8c", "", "\xe0\xb8\x92", "\xe0\xb8\xac", "\xe0\xb8\xa6", "", "CLEAR"],
				["SHIFT", "SPACE", "OK", "LEFT", "RIGHT"]]
			self.nextLang = 'en_US'
		else:
			self.keys_list = [
