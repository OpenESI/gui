...
class FlashManager(Screen):
	...
	def getImagesList(self):
		...
		if not self.imagesList:
			...
			try:
				...
				self.imagesList = {}
			searchFolders = []
			# Get all folders of /media/ and /media/net/ and only if OpenESI
			if not index:
	...
	def keyDistribution(self):
		...
		try:
			req = Request("https://raw.githubusercontent.com/OpenESI/FlashImage/gh-pages/%s.json" % machine, None, USER_AGENT)
